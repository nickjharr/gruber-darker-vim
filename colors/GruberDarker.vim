...
call <sid>hi('Boolean',       s:gruberQuartz,     '',            s:bold,          '')
call <sid>hi('Character',     s:gruberGreen,      '',            'bold',          '')
call <sid>hi('Comment',       s:gruberBrown,      '',            s:bold,    '')
call <sid>hi('Conditional',   s:gruberMain,       '',            s:bold,          '')
call <sid>hi('Constant',      s:gruberQuartz,     '',            s:bold,          '')
call <sid>hi('Define',        s:gruberMain,       '',            s:bold,          '')
call <sid>hi('Delimiter',     s:gruberFG,         '',            s:bold,          '')
call <sid>hi('Float',         s:gruberQuartz,     '',            s:bold,          '')
call <sid>hi('Function',      s:gruberNiagara,    '',            s:bold,          '')
call <sid>hi('Identifier',    s:gruberNiagara,    '',            s:bold,          '')
call <sid>hi('Include',       s:gruberMain,       '',            s:bold,          '')
call <sid>hi('Keyword',       s:gruberMain,       '',            s:bold,          '')
call <sid>hi('Label',         s:gruberFG,         '',            s:bold,          '')
call <sid>hi('Number',        s:gruberQuartz,     '',            s:bold,          '')
call <sid>hi('Operator',      s:gruberFG,         '',            s:bold,          '')
call <sid>hi('PreProc',       s:gruberFG1,        '',            s:bold,          '')
call <sid>hi('Repeat',        s:gruberMain,       '',            s:bold,          '')
call <sid>hi('Special',       s:gruberMain,       '',            s:bold,          '')
call <sid>hi('SpecialChar',   s:gruberMain,       '',            s:bold,          '')
call <sid>hi('Statement',     s:gruberMain,       '',            s:bold,          '')
call <sid>hi('StorageClass',  s:gruberMain,       '',            s:bold,          '')
call <sid>hi('String',        s:gruberGreen,      '',            s:bold,          '')
call <sid>hi('Structure',     s:gruberMain,       '',            s:bold,          '')
call <sid>hi('Todo',          s:gruberBG,         s:gruberMain,  s:bold,          '')
call <sid>hi('Type',          s:gruberQuartz,     '',            s:bold,          '')
call <sid>hi('Typedef',       s:gruberQuartz,     '',            s:bold,          '')
