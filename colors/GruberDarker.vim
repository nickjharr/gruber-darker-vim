...
call <sid>hi('Boolean',       s:gruberQuartz,     '',            'bold',          '')
...
call <sid>hi('Constant',      s:gruberQuartz,     '',            'bold',          '')
call <sid>hi('Define',        s:gruberMain,       '',            'bold',          '')
call <sid>hi('Delimiter',     s:gruberFG,         '',            'bold',          '')
call <sid>hi('Float',         s:gruberQuartz,     '',            'bold',          '')
call <sid>hi('Function',      s:gruberNiagara,    '',            'bold',          '')
call <sid>hi('Identifier',    s:gruberNiagara,    '',            'bold',          '')
call <sid>hi('Include',       s:gruberMain,       '',            'bold',          '')
call <sid>hi('Keyword',       s:gruberMain,       '',            'bold',          '')
call <sid>hi('Label',         s:gruberFG,         '',            'bold',          '')
call <sid>hi('Number',        s:gruberQuartz,     '',            'bold',          '')
call <sid>hi('Operator',      s:gruberFG,         '',            'bold',          '')
call <sid>hi('PreProc',       s:gruberFG1,        '',            'bold',          '')
call <sid>hi('Repeat',        s:gruberMain,       '',            'bold',          '')
call <sid>hi('Special',       s:gruberMain,       '',            'bold',          '')
call <sid>hi('SpecialChar',   s:gruberMain,       '',            'bold',          '')
call <sid>hi('Statement',     s:gruberMain,       '',            'bold',          '')
call <sid>hi('StorageClass',  s:gruberMain,       '',            'bold',          '')
call <sid>hi('String',        s:gruberGreen,      '',            'bold',          '')
call <sid>hi('Structure',     s:gruberMain,       '',            'bold',          '')
call <sid>hi('Todo',          s:gruberBG,         s:gruberMain,  'bold',          '')
call <sid>hi('Type',          s:gruberQuartz,     '',            'bold',          '')
call <sid>hi('Typedef',       s:gruberQuartz,     '',            'bold',          '')
